...
class Memory : protected Pointers {
 public:
  ...
  template <typename TYPE>
  TYPE ***create2d_offset(TYPE ***& , int , int , int ,
                          const char *name)
  {
    fail(name);
    return nullptr;
  ...
  template <typename TYPE>
  TYPE ****create3d_offset(TYPE ****& , int , int , int , int ,
                           const char *name)
  {
    fail(name);
    return nullptr;
  ...
  template <typename TYPE>
  TYPE ****create3d_offset(TYPE ****& , int , int , int ,
  ...
  template <typename TYPE>
  TYPE ***create3d_offset_last(TYPE ****& , int , int ,
                               int , int , int ,
                               const char *name)
  ...
  template <typename TYPE>
  TYPE *****create(TYPE *****& , int , int , int , int ,
                   const char *name)
  {
    fail(name);
    return nullptr;
  ...
  template <typename TYPE>
  TYPE *****grow(TYPE *****& , int , int , int , int ,
                 const char *name)
  {
    fail(name);
    return nullptr;
  ...
  template <typename TYPE>
  TYPE ****create4d_offset(TYPE *****& , int , int , int ,
                           int , int , int , int , const char *name)
  {
    fail(name);
    return nullptr;
  }
  ...
  template <typename TYPE>
  TYPE ****create4d_offset_last(TYPE *****& , int , int , int ,
                                int , int , int , int ,
                                const char *name)
  {
    fail(name);
